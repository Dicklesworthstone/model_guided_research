...
- Run ID: `seed_5`
- Generated: 2026-09-02T21:56:42Z
- Artifacts: `runs/budget_0/placebo/standard/seed_5`
...
```bash
uv run python -m nanochat.train --device cpu --seed 5 --batch-size 4 --sequence-len 64 --n-layer 2 --n-head 4 --n-kv-head 2 --n-embd 64 --learning-rate 0.0006 --optimizer-type adamw --tokenizer task --warmup-steps 0 --log-interval 1 --attention-type standard --target-flops 1000000000000.0 --checkpoint-interval 1000 --checkpoint-keep 1 --data-dir /data/projects/model_guided_research/artifacts/scorecards/dyck-comparison-tasktok-1e12/data/placebo --min-parquet-files 2 --artifacts-dir /data/projects/model_guided_research/artifacts/scorecards/dyck-comparison-tasktok-1e12 --artifacts-kind runs --artifacts-topic budget_0/placebo/standard --run-id seed_5 --check-numerics
```
...
- measured_time_s: 66.310
- tokens/s: 19,180
- TFLOP/s (est): 0.02
- peak_memory_allocated_gb: n/a
- final_train_ce: 1.4352
- val_interval: 0
- val_batches: n/a
- final_val_ce: n/a
