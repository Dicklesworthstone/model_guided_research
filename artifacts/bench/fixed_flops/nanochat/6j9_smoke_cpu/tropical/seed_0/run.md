...
- Run ID: `seed_0`
- Generated: 2025-12-18T06:53:31Z
- Artifacts: `bench/fixed_flops/nanochat/6j9_smoke_cpu/tropical/seed_0`
- Commit: 95ab717124a53d816acfdc82d21628e443b811df (dirty)

## Command

```bash
uv run python -m nanochat.train --device cpu --seed 0 --batch-size 2 --sequence-len 64 --n-layer 2 --n-head 2 --n-kv-head 2 --n-embd 64 --learning-rate 0.0006 --optimizer-type adamw --attention-type tropical --target-flops 2000000000.0 --warmup-steps 0 --log-interval 1 --artifacts-dir artifacts --artifacts-kind bench --artifacts-topic fixed_flops/nanochat/6j9_smoke_cpu/tropical --run-id seed_0 --auto-download-data --min-parquet-files 2
```
