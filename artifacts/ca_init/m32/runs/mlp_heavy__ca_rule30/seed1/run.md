...
- Run ID: `seed1`
- Generated: 2026-06-14T11:03:54Z
- Artifacts: `ca_init/m32/runs/mlp_heavy__ca_rule30/seed1`
- Commit: 504e2f375f1dcbbdb000700d45b3069fd1269a77 (dirty)

## Command

```bash
uv run python -m nanochat.train --device cpu --seed 1 --attention-type standard --optimizer-type adamw --learning-rate 0.0006 --max-steps 120 --warmup-steps 5 --log-interval 1 --vocab-size 50304 --n-layer 6 --n-head 2 --n-kv-head 2 --n-embd 128 --sequence-len 32 --batch-size 8 --ca-init-rule rule30 --ca-init-alpha 1 --artifacts-dir artifacts --artifacts-kind ca_init --artifacts-topic m32/runs/mlp_heavy__ca_rule30 --run-id seed1 --auto-download-data --min-parquet-files 2
```
...
- measured_time_s: 133.629
- tokens/s: 220
- TFLOP/s (est): 0.01
- peak_memory_allocated_gb: n/a
- final_train_ce: 7.3851
- val_interval: 0
- val_batches: n/a
- final_val_ce: n/a
