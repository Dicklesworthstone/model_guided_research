...
- Run ID: `seed_2`
- Generated: 2026-09-02T21:51:55Z
...
```bash
uv run python -m nanochat.train --device cpu --seed 2 --batch-size 4 --sequence-len 64 --n-layer 2 --n-head 4 --n-kv-head 2 --n-embd 64 --learning-rate 0.0006 --optimizer-type adamw --tokenizer task --warmup-steps 0 --log-interval 1 --attention-type standard --target-flops 1000000000000.0 --checkpoint-interval 1000 --checkpoint-keep 1 --data-dir /data/projects/model_guided_research/artifacts/probes/sizing/scorecards/vdc4-regime-v2-tasktok-shuf-b1-rung/data/placebo --min-parquet-files 2 --artifacts-dir /data/projects/model_guided_research/artifacts/probes/sizing/scorecards/vdc4-regime-v2-tasktok-shuf-b1-rung --artifacts-kind runs --artifacts-topic budget_0/placebo/standard --run-id seed_2 --check-numerics
```
...
- measured_time_s: 157.240
- tokens/s: 8,088
- TFLOP/s (est): 0.01
- peak_memory_allocated_gb: n/a
- final_train_ce: 1.4641
- val_interval: 0
- val_batches: n/a
- final_val_ce: n/a
