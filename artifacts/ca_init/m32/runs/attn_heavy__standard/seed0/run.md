...
- Run ID: `seed0`
- Generated: 2026-06-14T10:41:37Z
- Artifacts: `ca_init/m32/runs/attn_heavy__standard/seed0`
- Commit: 504e2f375f1dcbbdb000700d45b3069fd1269a77 (dirty)

## Command

```bash
uv run python -m nanochat.train --device cpu --seed 0 --attention-type standard --optimizer-type adamw --learning-rate 0.0006 --max-steps 120 --warmup-steps 5 --log-interval 1 --vocab-size 50304 --n-layer 4 --n-head 8 --n-kv-head 8 --n-embd 128 --sequence-len 256 --batch-size 4 --ca-init-rule none --artifacts-dir artifacts --artifacts-kind ca_init --artifacts-topic m32/runs/attn_heavy__standard --run-id seed0 --auto-download-data --min-parquet-files 2
```
...
- measured_time_s: 138.590
- tokens/s: 850
- TFLOP/s (est): 0.04
- peak_memory_allocated_gb: n/a
- final_train_ce: 7.4218
- val_interval: 0
- val_batches: n/a
- final_val_ce: n/a
