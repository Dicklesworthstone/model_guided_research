# Mechanism scorecard — vdc4-needle-tasktok-shuf-b2-rung

- Original command: `/data/projects/model_guided_research-worktrees/vdc4-copyops-tasktok-shuf-5dce958/cli.py scorecard --budget 2e12 --mechanism standard --task needle --seeds 3 --eval-seeds 0,1,2 --examples 48 --dataset-size 100000 --dataset-seed 42 --device cpu --batch-size 4 --sequence-len 64 --n-layer 2 --n-head 4 --n-kv-head 2 --n-embd 64 --learning-rate 6e-4 --optimizer-type adamw --tokenizer task --warmup-steps 0 --log-interval 1 --val-interval 0 --checkpoint-interval 1000 --min-evidence-steps 10 --timeout-s 36000 --artifacts-dir /data/projects/model_guided_research/artifacts/probes/sizing --run-id vdc4-needle-tasktok-shuf-b2-rung --fresh`
...
|---|---:|---|---|---:|---|---|---:|---:|---|
| b0-needle-standard-s0 | 2.000e+12 | standard | needle | 0 | done | STEP-ONLY | 317.69 | 2.965037 | logs/b0-needle-standard-s0.eval.stderr.txt |
| b0-needle-standard-s1 | 2.000e+12 | standard | needle | 1 | done | STEP-ONLY | 498.62 | 2.982212 | logs/b0-needle-standard-s1.eval.stderr.txt |
| b0-needle-standard-s2 | 2.000e+12 | standard | needle | 2 | done | STEP-ONLY | 160.99 | 2.911731 | logs/b0-needle-standard-s2.eval.stderr.txt |
| b0-placebo-standard-s0 | 2.000e+12 | standard | placebo | 0 | done | OFF-FLOOR | 160.88 | 1.599563 | logs/b0-placebo-standard-s0.eval.stderr.txt |
| b0-placebo-standard-s1 | 2.000e+12 | standard | placebo | 1 | done | OFF-FLOOR | 160.42 | 1.430413 | logs/b0-placebo-standard-s1.eval.stderr.txt |
| b0-placebo-standard-s2 | 2.000e+12 | standard | placebo | 2 | done | OFF-FLOOR | 167.44 | 1.391085 | logs/b0-placebo-standard-s2.eval.stderr.txt |
