# Mechanism scorecard — vdc4-bag-tasktok-shuf-b2-s256-rung

- Original command: `/data/projects/model_guided_research-worktrees/regime-v2-e7f5845/cli.py scorecard --budget 2e12 --mechanism standard --task bag --seeds 3 --eval-seeds 0,1,2 --examples 48 --dataset-size 100000 --dataset-seed 42 --device cpu --batch-size 4 --sequence-len 256 --n-layer 2 --n-head 4 --n-kv-head 2 --n-embd 64 --learning-rate 6e-4 --optimizer-type adamw --tokenizer task --warmup-steps 0 --log-interval 1 --val-interval 0 --checkpoint-interval 1000 --min-evidence-steps 10 --timeout-s 36000 --artifacts-dir /data/projects/model_guided_research/artifacts/probes/sizing --run-id vdc4-bag-tasktok-shuf-b2-s256-rung --fresh`
...
|---|---:|---|---|---:|---|---|---:|---:|---|
| b0-bag-standard-s0 | 2.000e+12 | standard | bag | 0 | done | STEP-ONLY | 108.49 | 1.278088 | logs/b0-bag-standard-s0.eval.stderr.txt |
| b0-bag-standard-s1 | 2.000e+12 | standard | bag | 1 | done | STEP-ONLY | 58.14 | 1.275153 | logs/b0-bag-standard-s1.eval.stderr.txt |
| b0-bag-standard-s2 | 2.000e+12 | standard | bag | 2 | done | STEP-ONLY | 79.89 | 1.274260 | logs/b0-bag-standard-s2.eval.stderr.txt |
| b0-placebo-standard-s0 | 2.000e+12 | standard | placebo | 0 | done | OFF-FLOOR | 93.47 | 1.494446 | logs/b0-placebo-standard-s0.eval.stderr.txt |
| b0-placebo-standard-s1 | 2.000e+12 | standard | placebo | 1 | done | OFF-FLOOR | 160.93 | 1.475128 | logs/b0-placebo-standard-s1.eval.stderr.txt |
| b0-placebo-standard-s2 | 2.000e+12 | standard | placebo | 2 | done | OFF-FLOOR | 163.85 | 1.477779 | logs/b0-placebo-standard-s2.eval.stderr.txt |
